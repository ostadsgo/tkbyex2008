...
class TranslateBook(tk.Tk):
    def __init__(self):
        ...
        self.languages_menu.add_command(
            label="Portuguese", command=self.add_portuguese_tab
        )
        ...
        self.translate_button = tk.Button(
            ...
            elems=[self.italian_translation]: self.translate(langs, None, elems),
        )

        self.translate_button.pack(side=tk.BOTTOM, fill=tk.X)
        self.italian_label = tk.Label(
            italian_tab, textvar=self.italian_translation, bg="lightgray", fg="black"
        )
    ...
    def add_portuguese_tab(self, text=None):
        ...
        self.portuguese_copy_button = tk.Button(
            portuguese_tab,
        ...
        self.translate_button.config(
            command=lambda langs=["it", "pt"],
            elems=[
                self.italian_translation,
